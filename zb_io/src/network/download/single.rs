...
impl Downloader {
    ...
    pub async fn download_with_progress(
        ...
        if self.blob_cache.has_blob(expected_sha256) {
            ...
            if verify_cached_blob(&blob_path, expected_sha256)? {
            ...
            self.remove_blob(expected_sha256);
        }
...
fn verify_cached_blob(path: &std::path::Path, expected_sha256: &str) -> Result<bool, Error> {
